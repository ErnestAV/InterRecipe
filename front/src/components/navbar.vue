<template>
    <div class="w-full">
        <div class="w-full flex md:px-16 px-10 pb-5 md:pb-0 flex-col md:flex-row md:justify-between md:items-center">
            <div class="flex flex-row items-center">
                <img height="80" width="80" src="https://cdn.freelogovectors.net/wp-content/uploads/2020/07/allrecipes-logo.png" alt="" srcset="">
