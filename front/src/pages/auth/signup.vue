    ...
    <div class="w-screen flex md:justify-center">
        <form class="bg-white w-full mt-20 md:w-1/3 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="flex justify-center">
                <img height="100" width="100" src="https://cdn.freelogovectors.net/wp-content/uploads/2020/07/allrecipes-logo.png" alt="" srcset="">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input v-model="lastname" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Username">
            </div>
            <div class="mb-4">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
                    Username
